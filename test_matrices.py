...
@pytest.mark.parametrize(
    ...
    [
        (np.array([[1, 0], [0, 1]], dtype=np.float64), np.array([1, 1], dtype=np.float64)),
        (np.array([[2, 1], [1, 2]], dtype=np.float64), np.array([1, 3], dtype=np.float64)),
        (np.array([[0, 0], [0, 0]], dtype=np.float64), np.array([0, 0], dtype=np.float64)),
    ],
...
def test_construct_matrix(ligand_field_theory, diag_elements, off_diag_elements, expected_matrix):
    # Act
